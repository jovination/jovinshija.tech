      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="border-[#222323] bg-[#222323] rounded-2xl">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-[#FFFFFE]">Total Messages</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#FFFFFE]">{totalMessages}</div>
            <p className="text-xs text-[#FFFFFE]/60">Messages received this week</p>
          </CardContent>
        </Card>
        <Card className="border-[#222323] bg-[#222323] rounded-2xl">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-[#FFFFFE]">Total Emails</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#FFFFFE]">{totalEmails}</div>
            <p className="text-xs text-[#FFFFFE]/60">Emails received this week</p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data}>
                ...
                <Bar dataKey="emails" fill="#222323" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
