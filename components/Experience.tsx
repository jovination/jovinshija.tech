...
function Experience(){
    ...
    <div className="mt-16 w-[370px] h-[135px]  md:w-[550px] md:h-[172px] border border-[#404141] rounded-[30px]  md:rounded-[36px]  px-[48px] py-[40px] md:px-[60px] md:py-[50px] flex items-center gap-[40px]"> 
     <div>
    ...
    <div className="h-full flex flex-col justify-end">
      ...
      <p className="md:leading-1 text-sm md:text-base text-white font-medium">
        ...
        <div className="w-[183px] md:w-[273px] h-[183px] md:h-[273px]  rounded-[30px] md:rounded-[36px] relative overflow-hidden">
          ...
          <div className="w-[183px] md:w-[273px] h-[183px] md:h-[273px] bg-[--primary] rounded-[30px] md:rounded-[36px] p-[32px] md:p-[40px] flex flex-col justify-between  "
          >
              <Image
